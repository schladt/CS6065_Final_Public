...
fig_units_by_year = px.bar(units_year_df, x="YEAR", y="UNITS", title='Units by Year')
...
fig_units_by_month = px.line(units_month_df, x="PURCHASE_MONTH", y="UNITS", title="Units by Month", markers=True)
...
fig_units_by_week = px.line(units_week_df, x="WEEK_NUM", y="UNITS", title="Units by Week", markers=True)
...
fig_units_by_region = px.pie(units_region_df, values='UNITS', names='STORE_REGION', title='Units by Store Region')
...
fig_spend_by_year = px.bar(spend_year_df, x="YEAR", y="SPEND", title='Spend by Year')
...
fig_spend_by_month = px.line(spend_month_df, x="PURCHASE_MONTH", y="SPEND", title="Spend by Month", markers=True)
...
fig_spend_by_week = px.line(spend_week_df, x="WEEK_NUM", y="SPEND", title="Spend by Week", markers=True)
...
fig_spend_by_region = px.pie(spend_region_df, values='SPEND', names='STORE_REGION', title='Spend by Store Region')
...
fig_spend_by_marital = px.pie(spend_marital_df, values='SPEND', names='MARITAL', title='Spend by Martial Status')
...
fig_spend_by_children = px.pie(spend_children_df, values='SPEND', names='CHILDREN', title='Spend by Number of Children')
...
fig_spend_by_hshdcomposition = px.pie(spend_hshdcomposition_df, values='SPEND', names='HSHD_COMPOSITION', title='Spend by Household Composition')
...
fig_units_by_region_over_year = px.sunburst(units_by_region_over_year_df, path=['YEAR', 'STORE_R'], values='UNITS', title="Units by Region")

# spend by region over year
fig_spend_by_region_over_year = px.sunburst(units_by_region_over_year_df, path=['YEAR', 'STORE_R'], values='SPEND', title="Spend By Region")
...
fig_units_by_dept_over_year_df = px.sunburst(units_by_dept_over_year_df, path=['YEAR', 'DEPARTMENT'], values='UNITS', title="Units By Department")
fig_spend_by_dept_over_year_df = px.sunburst(units_by_dept_over_year_df, path=['YEAR', 'DEPARTMENT'], values='SPEND', title="Spend By Department")
...
fig_units_by_agerange_over_year = px.bar(units_by_agerange_over_year_df,
        x="AGE_RANGE", y="UNITS", color="YEAR", barmode="group", title="Units by Age Range")

# spend by agerange over a year
fig_spend_by_agerange_over_year = px.bar(units_by_agerange_over_year_df, 
    x="AGE_RANGE", y="SPEND", color="YEAR", barmode="group", title="Spend By Age Range")

# spend by agerange over a year
fig_units_by_incomerange_over_year_df = px.bar(units_by_incomerange_over_year_df, 
    x="INCOME_RANGE", y="UNITS", color="YEAR", barmode="group", title="Units by Income Level")

fig_spend_by_incomerange_over_year_df = px.bar(units_by_incomerange_over_year_df, 
...
dashboard_layout = html.Div(children=[
        ...
        dbc.Row([
            ...
            dbc.Col(html.Div([dcc.Graph(figure=fig_units_by_year)]), width=3),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_year)]), width=3),
            dbc.Col(html.Div([dcc.Graph(figure=fig_units_by_region_over_year)]), width=3),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_region_over_year)]), width=3)    


        ]),

        dbc.Row([
            dbc.Col(html.Div([dcc.Graph(figure=fig_units_by_month)]), width=6),
            dbc.Col(html.Div([dcc.Graph(figure=fig_units_by_week)]), width=6),
        ]),

        dbc.Row([
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_month)]), width=6),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_week)]), width=6),
        ]),

        dbc.Row([
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_marital)]), width=4),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_children)]), width=4),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_hshdcomposition)]), width=4)
        ]),

        dbc.Row([
            dbc.Col(html.Div([dcc.Graph(figure=fig_units_by_dept_over_year_df)]), width=6),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_dept_over_year_df)]), width=6)    
        ]),
        
        

        dbc.Row([
            dbc.Col(html.Div([dcc.Graph(figure=fig_units_by_agerange_over_year)]), width=6),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_agerange_over_year)]), width=6), 
        ]),

        

        dbc.Row([
            dbc.Col(html.Div([dcc.Graph(figure=fig_units_by_incomerange_over_year_df)]), width=6),
            dbc.Col(html.Div([dcc.Graph(figure=fig_spend_by_incomerange_over_year_df)]), width=6), 
        ]),
